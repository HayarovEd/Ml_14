...
android {
    namespace = "com.expensemanager.plus"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.expensemanager.plus"
        minSdk = 21
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        getByName("debug") {
            storeFile = file("ID530.keystore")
            keyAlias = "mypass"
            storePassword = "com.expensemanager.plus"
            keyPassword = "com.expensemanager.plus"
        }
        create("release") {
            keyAlias = "mypass"
            keyPassword = "com.expensemanager.plus"
